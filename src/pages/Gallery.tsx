...
export const galleryItems = [
  {
    id: 1,
    image: "/Images/TheCarWash.jpg",
    title: "The Ultimate Facility",
    category: "Equipment"
  },
  {
    id: 2,
  ...
  {
    id: 3,
    image: "/Images/TruckInTheWash.jpg",
    title: "Heavy Duty Rinse",
    category: "Tunnel"
  },
  {
    id: 4,
    image: "/Images/WetTruck.jpg",
  ...
  {
    id: 6,
    image: "/Images/The_washing_place_at_night.jpg.webp",
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          ...
          className="absolute inset-y-0 w-1/2 bg-gradient-to-r from-transparent via-white/5 to-transparent skew-x-[-25deg]"
        />
      </div>
    </motion.div>
  );
