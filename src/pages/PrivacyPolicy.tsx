            ...
            <section className="pb-32 relative">
                <div className="max-w-4xl mx-auto px-6">
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="glass p-10 md:p-16 rounded-[40px] border border-white/10 text-white/80 leading-relaxed font-medium space-y-8 shadow-2xl shadow-neon-green/5"
                    >
                        <div>
                            <h2 className="font-display font-black text-3xl uppercase italic tracking-tight text-white mb-4">Introduction</h2>
                            <p>
                                This Privacy Policy outlines Clean Finish Car Wash's ("we", "our" or "the Company") practices with respect to information collected from users who access our website at cleanfinishcarwash.com ("Site"), or otherwise share personal information with us (collectively: "Users").
                            </p>
                        </div>

                        <div>
                            <h2 className="font-display font-black text-3xl uppercase italic tracking-tight text-white mb-4">Grounds for Data Collection</h2>
                            <p className="mb-4">
                                Processing of your personal information (meaning, any information which may potentially allow your identification with reasonable means; hereinafter "Personal Information") is necessary for the performance of our contractual obligations towards you and providing you with our services and car wash memberships, to protect our legitimate interests, and for compliance with legal and financial regulatory obligations to which we are subject.
                            </p>
                            <p className="mb-4">
                        ...
                        <div>
                            <h2 className="font-display font-black text-3xl uppercase italic tracking-tight text-white mb-4">What Information Do We Collect?</h2>
                            <p className="mb-4">
                        ...
                        <div>
                            <h2 className="font-display font-black text-3xl uppercase italic tracking-tight text-white mb-4">Retention</h2>
                            <p className="mb-4">
                                We will retain your personal information for as long as necessary to provide our services, and as necessary to comply with our legal obligations, resolve disputes, and enforce our policies. Retention periods will be determined taking into account the type of information that is collected and the purpose for which it is collected.
                            </p>
                            <p>
                        ...
                        <div>
                            <h2 className="font-display font-black text-3xl uppercase italic tracking-tight text-white mb-4">User Rights</h2>
                            <p className="mb-4">You may request to:</p>
                            <ul className="list-disc list-inside space-y-2 ml-4">
                                <li>Receive confirmation as to whether or not personal information concerning you is being processed</li>
                                <li>Receive a copy of personal information you directly volunteer to us</li>
                                ...
                                <li>Request to restrict processing of your personal information</li>
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="mt-12 glass p-8 md:p-12 rounded-[40px] border-2 border-racing-blue/20 bg-gradient-to-br from-racing-blue/5 to-transparent"
                    >
